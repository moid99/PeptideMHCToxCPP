# -*- coding: utf-8 -*-
"""CellPenetratingPredictor.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1u0mN8W23k2v0Jpd6tStksUNSbMBEY7OD
"""
...
model = load_checkpoint('CellPenetratingModel.pth')
...
for value in X:
  ...
  answer = pred_rd.item()
  if answer == 0:
    print('non-cell-penetrating')
  else:
    print('cell-penetrating')